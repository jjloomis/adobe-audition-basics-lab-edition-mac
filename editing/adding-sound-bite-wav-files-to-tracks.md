...
<figure><img src="../.gitbook/assets/adding-sound-bite-wav-files-to-tracks.png" alt="Adding sound bite WAV files to audio tracks"><figcaption><p>Adding sound bite WAV files to audio tracks.</p></figcaption></figure>
