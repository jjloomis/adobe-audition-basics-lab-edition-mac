...
<figure><img src="../.gitbook/assets/copying-wav-files-to-project-folder.png" alt="Copying WAV files from a Zoom H2n into a project folder"><figcaption><p>Copying WAV files from a Zoom H2n into a project folder.</p></figcaption></figure>
